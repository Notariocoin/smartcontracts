...
//is equivalent to
import './imports.sol';
contract NOTAt is ERC20Burnable, ERC20PresetMinterPauser { 
    ...
    constructor () ERC20PresetMinterPauser("NOTARIOCOIN", "NOTA") {
        ...
        //... en estas 4 direcciones
        _mint( __put here the 1st account provided by truffle__ , 300000000 ether); //__privatesale
        _mint( __put here the 2nd account provided by truffle__ ,  50000000 ether); //__privatesale2
        _mint( __put here the 3rd account provided by truffle__ , 150000000 ether); //__publicsale
        _mint( __put here the 4th account provided by truffle__ ,  50000000 ether); //__team
        //Las buenas son las siguientes 4
        ...
        _mint(0xa2acDFcbeC6A098c9f452DF3Aa94E5E106aA925a , 280000000 ether); //__airdrops
        _mint(0x24fEDee95aa8B27a82D34e4867565Ee7Dd508818 ,  20000000 ether); //__reserved
